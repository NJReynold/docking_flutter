...
void main() {
  ...
  group('LayoutParser - stringify', () {
    ...
    test('stringifyArea', () {
      ...
      final DockingItem itemB = DockingItem(widget: Container(), weight: .2);
    ...
    test('stringifyArea - CustomIdParser', () {
      ...
      final LayoutParser parser = CustomIdParser();
    ...
    test('stringifyArea - CustomIdClassParser', () {
      ...
      final LayoutParser parser = CustomIdClassParser();
...
class CustomIdParser extends DefaultLayoutParser {
  ...
  dynamic stringToId(String id) {
    final double v = double.parse(id);
    return v - 1;
  }
}
...
class CustomIdClassParser extends DefaultLayoutParser {
  @override
  String idToString(dynamic id) {
    final CustomClass customClass = id as CustomClass;
